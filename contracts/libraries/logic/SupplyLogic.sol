...
library SupplyLogic {
  ...
  function executeDeposit(
    ...
    IERC20(params.asset).safeTransferFrom(params.initiator, bToken, params.amount);

    IlolToken(bToken).mint(params.onBehalfOf, params.amount, reserve.liquidityIndex);
  ...
  function executeWithdraw(
    ...
    uint256 userBalance = IlolToken(bToken).balanceOf(params.initiator);
    ...
    IlolToken(bToken).burn(params.initiator, params.to, amountToWithdraw, reserve.liquidityIndex);
